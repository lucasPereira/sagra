...
public class TesteCodigoDeEstado {
	...
	public void testar() throws Exception {
		assertEquals(4, CodigoDeEstado.values().length);
		assertEquals(CodigoDeEstado.HTTP200, CodigoDeEstado.values()[0]);
		assertEquals(CodigoDeEstado.HTTP201, CodigoDeEstado.values()[1]);
		assertEquals(CodigoDeEstado.HTTP204, CodigoDeEstado.values()[2]);
		assertEquals(CodigoDeEstado.HTTP400, CodigoDeEstado.values()[3]);
	}
